...
def upgrade() -> None:
    ...
    op.create_table('assets',
        ...
        sa.Column('asset_metadata', sa.Text(), nullable=True, server_default='{}'),
    ...
    op.create_table('indicators',
        ...
        sa.Column('parameters', sa.Text(), nullable=True, server_default='{}'),
    ...
    op.create_table('signals',
        ...
        sa.Column('strength', sa.String(length=20), nullable=True, server_default='moderate'),
        ...
        sa.Column('indicators_used', sa.Text(), nullable=True, server_default='[]'),
        sa.Column('timeframe', sa.String(length=10), nullable=True, server_default='1d'),
        sa.Column('is_active', sa.String(length=10), nullable=True, server_default='true'),
